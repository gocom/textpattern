...
p. Released under the GNU General Public License. See "textpattern/license.txt":textpattern/license.txt for terms and conditions.

p. Includes contributions licensed under the GNU Lesser General Public License. See "textpattern/lgpl-2.1.txt":textpattern/lgpl-2.1.txt for terms and conditions.

p. Includes contributions licensed under the New BSD License.
